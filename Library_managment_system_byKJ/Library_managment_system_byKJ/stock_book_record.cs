...
namespace Library_managment_system_byKJ
{
        ...
        public partial class stock_book_record : Form
    {
            SqlConnection con = new SqlConnection(@"Data Source=.;Initial Catalog=library_Managment_system_by_kj;Integrated Security=True");

        public stock_book_record()
        {
            InitializeComponent();
        }

        private void stock_book_record_Load(object sender, EventArgs e)
        {
        ...
        private void tb_Stock_FirstBox_TextChanged(object sender, EventArgs e)
        {
