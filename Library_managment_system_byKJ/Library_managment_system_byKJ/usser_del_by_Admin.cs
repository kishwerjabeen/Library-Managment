...
{
    public partial class usser_del_by_Admin : Form
    {
        SqlConnection con;
        SqlCommandBuilder builder;
        SqlDataAdapter da;
        DataSet ds;
        public usser_del_by_Admin()
        {
            InitializeComponent();
        ...
        private void usser_del_by_Admin_Load(object sender, EventArgs e)
        {
            ds = new DataSet();
            da = new SqlDataAdapter("SELECT  * FROM Student_info_new", con);
